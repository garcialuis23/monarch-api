...
SELECT * FROM MONARCA WHERE ID_MONARCA = 1;

SELECT * FROM DINASTIA_TIENE_NOMBRE;

SELECT NOMBRE FROM MONARCA;

SELECT * FROM MONARCA_REINA_REINO;

-- PARA SABER SI HAY NOMBRES REPETIDOS EN LA DINASTIA.
SELECT NOMBRE_DINASTIA, NOMBRE_PROPIO, COUNT(*) AS cantidad
FROM DINASTIA_TIENE_NOMBRE
GROUP BY NOMBRE_DINASTIA, NOMBRE_PROPIO
HAVING COUNT(*) > 1;

SELECT * FROM NOMBRE_PROPIO;

SELECT * FROM DINASTIA_TIENE_NOMBRE;

SELECT * FROM MONARCA;
 
SELECT * FROM REINO WHERE ID_MONARCA = 9;

DELETE FROM REINO WHERE ID_REINO = 2;

SELECT SUPERFICIE FROM REINO WHERE ID_REINO = 1;

SELECT MAX(SUPERFICIE) AS SUPERFICIE_MAXIMA FROM REINO;

SELECT POBLACION FROM REINO WHERE ID_REINO = 2;

SELECT MAX(ID_REINO) FROM REINO;
...
SELECT MIN(SUPERFICIE) AS SUPERFICIE_MINIMA FROM REINO;

SELECT ID_MONARCA, NOMBRE_DINASTIA, NOMBRE, NIVEL_EXPERIENCIA, VIVO FROM MONARCA;
